...
def create_user(email='abc@example.com', password='test123'):
...
class PrivateIngredientApiTest(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        user2 = create_user(email='user12@example.com', password='ere23232')
    ...
    def test_delete_ingredient_successful(self):
        ...
        self.assertEqual(ingredient.exists(), False)
    ...
    def test_filter_ingredients_assigned_to_recipes(self):
        ...
        recipe = Recipe.objects.create(title='Cucumber', time_minutes=5, price=5.00,user=self.user)
    ...
    def test_filtered_ingredients_unique(self):
        ...
        recipe1 = Recipe.objects.create(title='Cucumber',time_minutes=6,price=5.00,user=self.user)
        recipe2 = Recipe.objects.create(title='Herb egg',time_minutes=12,price=5.00,user=self.user)
