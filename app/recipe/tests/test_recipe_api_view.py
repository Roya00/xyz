...
def create_recipe(user, **params): # param is optional
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        self.assertEqual(res.data, serializer.data) # res.data dictionary == serializer.data dictionary

    def test_recipe_list_limited_to_user(self):
        """Test list of recipes is limited to authenticated user."""
        other_user = create_user(email='otheruser@exapmle.com',
                                 password='test@123')
    ...
    # def test_all_info_not_provided(self):
    #     payload = {'title': 'Sample recipe',
    #                'time_minutes':30,
    #                'price':Decimal('5.90'),
    #                }
    #     self.client.post(RECIPES_URL, payload)
    #     ser = self.client.get(RECIPES_URL)
    #     self.assertNotContains(ser,'description')
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 4,
            'price': Decimal('32.32'),
            'ingredients': [{'name': 'Lemon'},{'name':'Juice'}]
        }
        res = self.client.post(RECIPES_URL,payload,format='json')
    ...
    #     r1 = create_recipe(user=self.user, title='Pulao')
    #     r2 = create_recipe(user=self.user, title='Maggi')
    #
    ...
    #     in2 = Ingredient.objects.create(user=self.user, name='Water')
    #
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self):  # execute after evert Test
        self.recipe.delete()


    def test_upload_image(self):
        """Test uploading imaage to a recipe"""
